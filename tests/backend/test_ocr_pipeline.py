...
# Demo packaging photos are served by the frontend out of public/samples/.
SAMPLE_IMAGE = PROJECT_ROOT / "public" / "samples" / "paracetamol_sample.jpg"
...
def test_api_ocr_with_real_packaging_sample():
    ...
    assert sample_path.exists(), f"missing demo image at {sample_path}"
