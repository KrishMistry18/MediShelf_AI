...
2. **Handling Humidity (% RH)**: Most solid oral dosage labels state *"Protect from moisture"* without quoting numerical RH percentages. In accordance with medical data ethics, **we do NOT invent arbitrary numbers**. Where unquantified, humidity fields are stored as `null`.
