...
*Note: No synthetic target probability or risk score is included in the feature vector. The model learns risk classification purely from raw and kinetic environmental/product features.*
